...
int main()
{
    ...
    if(s=="1"){
        cout << 2*(ll)pow(10, 10) << endl;
    }
    else if(s=="11"){
        cout << (ll)pow(10, 10) << endl;
    }
    else{
        ll cnt =0;
        string ss = "110";
        ...
        bool f3=true;
        rep(i, s.size()){
            if(ss[i%3]!=s[i]) f1=false;
            if(ss[(i+1)%3]!=s[i]) f2=false;
            if(ss[(i+2)%3]!=s[i]) f3=false;
            if(s[i]=='0') cnt++;
        }
        ...
        if(!f1 && !f2 && !f3){
            ...
            if(s[n-1]=='0'){
                cout << (ll)pow(10, 10)-cnt+1 << endl;
            }
            else{
                cout << (ll)pow(10, 10)-cnt << endl;
            }
        }
    }
