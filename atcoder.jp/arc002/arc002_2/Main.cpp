...
int main()
{
    ...
    st1.tm_year = stoi(ss[0], nullptr, 10);
    st1.tm_mon = stoi(ss[1], nullptr, 10);
    st1.tm_mday = stoi(ss[2], nullptr, 10);

    do{

        if (st1.tm_year % st1.tm_mon == 0 && (st1.tm_year / st1.tm_mon) % st1.tm_mday == 0){
            break;
        }
    ...
    printf("%d/%02d/%02d\n", st1.tm_year, st1.tm_mon, st1.tm_mday);
