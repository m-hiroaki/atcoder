...
int main()
{
    ...
    do
    {
        ...
        ll dx1 = v[ii[1]].first - v[ii[0]].first;
        ll dx2 = v[ii[2]].first - v[ii[0]].first;

        ll dy1 = v[ii[1]].second - v[ii[0]].second;
        ll dy2 = v[ii[2]].second - v[ii[0]].second;
    ...
    } while (next_combination(ii.begin(), ii.begin() + 3, ii.end()));
