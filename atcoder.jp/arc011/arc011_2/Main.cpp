...
char ToUpper(char cX) { return tolower(cX); } // 型の合うグローバル関数を定義する。
int main()
{
    ll n;
    string s;
    ...
    rep(i, n){
        ...
        rep(j, tmp.size())
        {
            ...
            else if (tmp[j] == 't' || tmp[j] == 'j')
            {
                f = true;
                ans += '3';
            }
            else if (tmp[j] == 'l' || tmp[j] == 'v')
            {
                f = true;
                ans += '5';
            }
            else if (tmp[j] == 'p' || tmp[j] == 'm')
            {
                f = true;
                ans += '7';
            }
            else if (tmp[j] == 'n' || tmp[j] == 'g')
            {
                f = true;
                ans += '9';
            }
            else if (tmp[j] == 'd' || tmp[j] == 'w')
            {
                f = true;
                ans += '2';
            }
            else if (tmp[j] == 'f' || tmp[j] == 'q')
            {
                f = true;
                ans += '4';
            }
            else if (tmp[j] == 's' || tmp[j] == 'x')
            {
                f = true;
                ans += '6';
            }
            else if (tmp[j] == 'h' || tmp[j] == 'k')
            {
                f = true;
                ans += '8';
            }
            else if (tmp[j] == 'z' || tmp[j] == 'r')
            {
                f = true;
                ans += '0';
            }
