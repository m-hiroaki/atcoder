...
int main()
{
    ...
    while(s.size() > 0){
        if( s.substr(0, dream.size()) == dream ){
            s = s.substr(dream.size());
        }
        else if (s.substr(0, dreamer.size()) == dreamer)
        {
            s = s.substr(dreamer.size());
        }
        else if (s.substr(0, erase.size()) == erase)
        {
            s = s.substr(erase.size());
        }
        else if (s.substr(0, eraser.size()) == eraser)
        {
            s = s.substr(eraser.size());
        }
        else{
            cout << "NO" << endl;
            return 0;
