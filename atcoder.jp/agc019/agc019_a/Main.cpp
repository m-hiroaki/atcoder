...
int main()
{
    ...
    v.push_back(make_pair(a * 4, 0.25));
    v.push_back(make_pair(b * 2, 0.50));
    v.push_back(make_pair(c * 1, 1.0));
    v.push_back(make_pair(d * 0.5, 2.0));
    ...
    if(v[0].second == 2.0){
        ans += (n / 2) * d;
        n %= 2;
        ans += (ll)(n / v[1].second) * (ll)(v[1].first * v[1].second);
    }
    else{
        ans += (ll)(n / v[0].second) * (ll)(v[0].first * v[0].second);
    }
